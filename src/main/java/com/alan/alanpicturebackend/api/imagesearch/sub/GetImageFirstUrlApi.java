...
/**
 * @author alan
 * @Description: 以图搜图-解析返回的页面，获取页面图片列表页面地址
 * @Date: 2025/4/16 17:38
 */
@Slf4j
public class GetImageFirstUrlApi {
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=15441540782385396663&sign=12175618a2dcbff59e95f01744796748&tpl_from=pc\n";
